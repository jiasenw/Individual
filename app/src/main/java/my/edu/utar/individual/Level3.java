    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                currenttv = arraytv[random.nextInt(16)];
                ...
                c = new CountDownTimer(time, 1000) {
                    ...
                    public void onFinish() {
                        ...
                        Toast.makeText(Level3.this, "U Lose", Toast.LENGTH_SHORT).show();
                    }
                };
                sec.setText("5");
                c.start();
        ...
        exitbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LinearLayout layout = new LinearLayout(Level3.this);
                layout.setOrientation(LinearLayout.VERTICAL);

                final EditText nameInput = new EditText(Level3.this);
                nameInput.setHint("Name");
                layout.addView(nameInput);

                final EditText scoreInput = new EditText(Level3.this);
                ...
                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(Level3.this, ScoreboardActivity.class);
                        ...
                        if (score == 16) {
                            ...
                            if (allClicked) {
                                if (grayedOutTextViews.size() == arraytv.length) {
                                    Toast.makeText(Level3.this, "You Won!", Toast.LENGTH_SHORT).show();
